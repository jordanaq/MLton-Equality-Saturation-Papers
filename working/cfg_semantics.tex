...
\begin{figure}[H]
  ...
  \begin{mathpar}
    ...
    \inferrule*[lab=\textsc{Match-Case}]
      {
        \llbracket R_p  \rrbracket_s = v_p \quad \llbracket c_i \rrbracket \sim \llbracket \bttt{c\_label}(v_p) \rrbracket \\
        \langle \texttt{goto}_{b_i} (R_{i,1}, \dots ), s \rangle \Downarrow r 
      }
      {
        \langle
          \texttt{match} (
            R_p ;
            \dots,
            c_i \Rightarrow \texttt{goto}_{b_i} (R_{i,1}, \dots, R_{i,n_i}),
            \dots; \dots
          ),
          s
        \rangle \Downarrow r
    ...
    \inferrule*[lab=\textsc{Match-Default}]
      {
        ...
        \langle \texttt{goto}_{b_d} (R_{d,1}, \dots ), s \rangle \Downarrow r
      }
      {
        \langle
          \texttt{match} (
            ...
            \dots,
            c_n \Rightarrow \dots;
            \Rightarrow \texttt{goto}_{b_{d}} (R_{d,1}, \dots )
          ),
          s
        \rangle \Downarrow r
      }
